...
$cacheFile = (__DIR__ .'/RSSCache.txt'); //To ensure full path

// Set unchanging Known variables
$known['action'] = "/like/edit";
$known['username'] = "Jeremy";
$known['known_api_key'] = "786xr6ooqna845majuvk+fparkix8pvd";
...
$mydescription = "PESOS from " . "<a href=\"" . $mylink. "\">" . 'Reading.am' . "</a>."; // Link to Reading.am
